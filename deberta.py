...
def main(args):
    class RiddleSolverTransform():
        ...
        def __call__(self, sample):
            ...
            ret_val = (formatted_questions, sample['label'])
            return ret_val
    ...
    class RiddleSolver(nn.Module):
        ...
        def evaluate(self, epoch):
            ...
            with torch.no_grad():
                ...
                for batch_questions, batch_labels in tqdm(self.test_loader):

                    #tokenize flattened choices
                    flattened_questions = [choice for riddle in batch_questions for choice in riddle]
        ...
        def train(self):
            ...
            for epoch in tqdm(range(self.epochs)): 
                ...
                for batch_questions, batch_labels in tqdm(self.train_loader):
                    ...
                    num_riddles = len(batch_labels)
                    outputs = outputs.view(num_riddles, 4)
